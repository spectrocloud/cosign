...
import (
	...
	_ "github.com/spectrocloud/cosign/v3/pkg/providers/github"

	// Link in the rest of the providers.
	_ "github.com/spectrocloud/cosign/v3/pkg/providers/buildkite"
	_ "github.com/spectrocloud/cosign/v3/pkg/providers/envvar"
	_ "github.com/spectrocloud/cosign/v3/pkg/providers/filesystem"
	_ "github.com/spectrocloud/cosign/v3/pkg/providers/google"
	_ "github.com/spectrocloud/cosign/v3/pkg/providers/spiffe"
)
